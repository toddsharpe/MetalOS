...
PIMAGE_SECTION_HEADER RuntimeSupport::GetPESection(const std::string& name, const uintptr_t ImageBase)
{
...
uintptr_t RuntimeSupport::GetProcAddress(Handle hModule, const char* lpProcName)
{
	//Headers
