...
volatile UINT8 x64::DOUBLEFAULT_STACK[IST_STACK_SIZE] = { 0 };
volatile UINT8 x64::NMI_Stack[IST_STACK_SIZE] = { 0 };
volatile UINT8 x64::DEBUG_STACK[IST_STACK_SIZE] = { 0 };
volatile UINT8 x64::MCE_STACK[IST_STACK_SIZE] = { 0 };

//Kernel Structures
volatile TASK_STATE_SEGMENT_64 x64::TSS64 =
{
	0, //Reserved
...
volatile KERNEL_GDTS x64::KernelGDT =
{
	...
	{ 0xFFFF, 0, 0, 0x2, true, UserDPL,	  true, 0xF, false, false, true, true, 0x00 }, //64-bit data User
	{
		...
		sizeof(x64::TSS64) - 1, (UINT16)&x64::TSS64, (UINT8)((UINT64)&x64::TSS64 >> 16), 0x9, false, 0, true, 0, false, false, false, true, (UINT8)((UINT64)&x64::TSS64 >> 24),
		// Base4						Zeroes
		QWordHigh(&x64::TSS64), 0, 0, 0
	}
};

volatile IDT_GATE x64::IDT[IDT_COUNT] =
{
...
DESCRIPTOR_TABLE x64::GDTR =
{
	sizeof(KernelGDT) - 1,
	(UINT64)& KernelGDT
};

DESCRIPTOR_TABLE x64::IDTR =
{
	sizeof(IDT) - 1,
	(UINT64)IDT
};
