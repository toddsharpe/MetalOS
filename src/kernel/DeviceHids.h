...
namespace DeviceHids
{
	...
	* NOTE(tsharpe): Ripped from ACPICA ahids.c
	*/
	const Entry  AslDeviceIds[] =
	{
		//ACPICA
	...
	const Entry* Lookup(const char *HardwareId)
	{
		for (const Entry *Info = AslDeviceIds; Info->Name; Info++)
		{
